...
<body>
    ...
    <div class="tab-wrap">
        ...
        <input id="TAB-02" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-02">フォロー</label>
        <div class="tab-content">
            <?php include("./group.php") ?>
        </div>
        <input id="TAB-03" type="radio" name="TAB" class="tab-switch" /><label class="tab-label" for="TAB-03">グループ</label>
        <div class="tab-content">
